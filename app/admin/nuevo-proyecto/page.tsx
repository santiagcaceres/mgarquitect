...
export default function NuevoProyectoPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.title.trim() || !formData.description.trim() || !formData.coverImage) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className="bg-gray-50 border-gray-300 text-gray-800 focus:border-black focus:ring-black"
                  placeholder="Ej: Residencial, Comercial, Industrial, etc."
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Describe el proyecto, sus características principales..."
              />
            </div>
